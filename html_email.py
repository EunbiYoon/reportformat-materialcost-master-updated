...
FL_html=FL_html.replace('<th style="color:navy;background-color:#EFE6FF; border:1px solid grey; border-collapse: collapse;">Substitute Change</th>','<th style="color:white;background-color:#75A701; border:1px solid grey; border-collapse: collapse;">Substitute Change</th>')
...
FL_html=FL_html.replace('<td style="background-color:white; border:1px solid grey; border-collapse: collapse;">Substitute Change</td>','<td style="font-weight:550; background-color:#75A701; color:white; border:1px solid grey; border-collapse: collapse;">Substitute Change</td>')
...
TL_html=TL_html.replace('<th style="color:navy;background-color:#EFE6FF; border:1px solid grey; border-collapse: collapse;">Substitute Change</th>','<th style="color:white;background-color:#75A701; border:1px solid grey; border-collapse: collapse;">Substitute Change</th>')
...
TL_html=TL_html.replace('<td style="background-color:white; border:1px solid grey; border-collapse: collapse;">Substitute Change</td>','<td style="font-weight:550; background-color:#75A701; color:white; border:1px solid grey; border-collapse: collapse;">Substitute Change</td>')
...
DR_html=DR_html.replace('<th style="color:navy;background-color:#EFE6FF; border:1px solid grey; border-collapse: collapse;">Substitute Change</th>','<th style="color:white;background-color:#75A701; border:1px solid grey; border-collapse: collapse;">Substitute Change</th>')
...
DR_html=DR_html.replace('<td style="background-color:white; border:1px solid grey; border-collapse: collapse;">Substitute Change</td>','<td style="font-weight:550; background-color:#75A701; color:white; border:1px solid grey; border-collapse: collapse;">Substitute Change</td>')

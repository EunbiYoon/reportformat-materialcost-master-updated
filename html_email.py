...
FL_html=FL_html.replace('<th style="color:navy;background-color:#EFE6FF; border:1px solid grey; border-collapse: collapse;">Price Change</th>','<th style="color:white;background-color:#638E00; border:1px solid grey; border-collapse: collapse;">Price Change</th>')
FL_html=FL_html.replace('<th style="color:navy;background-color:#EFE6FF; border:1px solid grey; border-collapse: collapse;">Substitute Change</th>','<th style="color:white;background-color:#638E00; border:1px solid grey; border-collapse: collapse;">Substitute Change</th>')
...
FL_html=FL_html.replace('<td style="background-color:white; border:1px solid grey; border-collapse: collapse;">Price Change</td>','<td style="font-weight:550; background-color:#638E00; color:white; border:1px solid grey; border-collapse: collapse;">Price Change</td>')
FL_html=FL_html.replace('<td style="background-color:white; border:1px solid grey; border-collapse: collapse;">Substitute Change</td>','<td style="font-weight:550; background-color:#638E00; color:white; border:1px solid grey; border-collapse: collapse;">Substitute Change</td>')
...
TL_html=TL_html.replace('<th style="color:navy;background-color:#EFE6FF; border:1px solid grey; border-collapse: collapse;">Price Change</th>','<th style="color:white;background-color:#638E00; border:1px solid grey; border-collapse: collapse;">Price Change</th>')
TL_html=TL_html.replace('<th style="color:navy;background-color:#EFE6FF; border:1px solid grey; border-collapse: collapse;">Substitute Change</th>','<th style="color:white;background-color:#638E00; border:1px solid grey; border-collapse: collapse;">Substitute Change</th>')
...
TL_html=TL_html.replace('<td style="background-color:white; border:1px solid grey; border-collapse: collapse;">Price Change</td>','<td style="font-weight:550; background-color:#638E00; color:white; border:1px solid grey; border-collapse: collapse;">Price Change</td>')
TL_html=TL_html.replace('<td style="background-color:white; border:1px solid grey; border-collapse: collapse;">Substitute Change</td>','<td style="font-weight:550; background-color:#638E00; color:white; border:1px solid grey; border-collapse: collapse;">Substitute Change</td>')
...
DR_html=DR_html.replace('<th style="color:navy;background-color:#EFE6FF; border:1px solid grey; border-collapse: collapse;">Price Change</th>','<th style="color:white;background-color:#638E00; border:1px solid grey; border-collapse: collapse;">Price Change</th>')
DR_html=DR_html.replace('<th style="color:navy;background-color:#EFE6FF; border:1px solid grey; border-collapse: collapse;">Substitute Change</th>','<th style="color:white;background-color:#638E00; border:1px solid grey; border-collapse: collapse;">Substitute Change</th>')
...
DR_html=DR_html.replace('<td style="background-color:white; border:1px solid grey; border-collapse: collapse;">Price Change</td>','<td style="font-weight:550; background-color:#638E00; color:white; border:1px solid grey; border-collapse: collapse;">Price Change</td>')
DR_html=DR_html.replace('<td style="background-color:white; border:1px solid grey; border-collapse: collapse;">Substitute Change</td>','<td style="font-weight:550; background-color:#638E00; color:white; border:1px solid grey; border-collapse: collapse;">Substitute Change</td>')
...
FL_item=FL_item.replace('<td style= "background-color:white; border:1px solid grey; border-collapse: collapse;">match</td>','<td style="background-color:#638E00; color:white; font-weight:550; border:1px solid grey; border-collapse: collapse;">match</td>')
FL_item=FL_item.replace('<td style= "background-color:white; border:1px solid grey; border-collapse: collapse;">price match</td>','<td style="background-color:#638E00; color:white; font-weight:550; border:1px solid grey; border-collapse: collapse;">price match</td>')
...
TL_item=TL_item.replace('<td style="background-color:white; border:1px solid grey; border-collapse: collapse;">match</td>','<td style= "background-color:#638E00; color:white; font-weight:550; border:1px solid grey; border-collapse: collapse;">match</td>')
TL_item=TL_item.replace('<td style="background-color:white; border:1px solid grey; border-collapse: collapse;">price match</td>','<td style= "background-color:#638E00; color:white; font-weight:550; border:1px solid grey; border-collapse: collapse;">price match</td>')
...
DR_item=DR_item.replace('<td style="background-color:white; border:1px solid grey; border-collapse: collapse;">match</td>','<td style= "background-color:#638E00; color:white; font-weight:550; border:1px solid grey; border-collapse: collapse;">match</td>')
DR_item=DR_item.replace('<td style="background-color:white; border:1px solid grey; border-collapse: collapse;">price match</td>','<td style= "background-color:#638E00; color:white; font-weight:550; border:1px solid grey; border-collapse: collapse;">price match</td>')
